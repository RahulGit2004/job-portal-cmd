...
const PaidFeatures = () => {
  ...
  const fetchPlans = async () => {
    try {
      const response = await axios.get(
        "http://localhost:8000/api/v1/subscription/get-all"
      );
  ...
  const handleToggleStatus = (index) => {
    const updatedPlans = [...plans];
    updatedPlans[index].status =
      updatedPlans[index].status === "Enabled" ? "Disabled" : "Enabled";
    setPlans(updatedPlans);
  };
        ...
        <div className="row justify-content-center">
          {plans.map((plan, index) => (
            <div className="col-md-4 mb-4" key={index}>
              ...
              <div
                className="card shadow-sm p-3 border rounded"
              ...
              >
                ...
                <div className="d-flex justify-content-end">
                  <button
                    ...
                    style={{
                      color: plan.status === "Enabled" ? "green" : "red",
                      cursor: "pointer",
                    }}
              ...
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title">
                    {isCreatingNew ? "Create New Plan" : `Edit ${tempName}`}
                  </h5>
                </div>
